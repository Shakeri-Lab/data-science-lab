 ...
 */
export interface IKernelIOPubStreamMessage extends IKernelMessage {
    content: {
        name: string;
        text: string;
    };
 ...
 */
export declare function isStreamMessage(msg: IKernelMessage): msg is IKernelIOPubStreamMessage;
/**
 ...
 */
export interface IKernelIOPubDisplayDataMessage extends IKernelMessage {
    content: {
        source: string;
        data: {
            [key: string]: string;
 ...
 */
export declare function isDisplayDataMessage(msg: IKernelMessage): msg is IKernelIOPubDisplayDataMessage;
/**
 ...
 */
export interface IKernelIOPubExecuteInputMessage extends IKernelMessage {
    content: {
        code: string;
 ...
 */
export declare function isExecuteInputMessage(msg: IKernelMessage): msg is IKernelIOPubExecuteInputMessage;
/**
 ...
 */
export interface IKernelIOPubExecuteResultMessage extends IKernelMessage {
    content: {
        execution_count: number;
        data: {
            [key: string]: string;
 ...
 */
export declare function isExecuteResultMessage(msg: IKernelMessage): msg is IKernelIOPubExecuteResultMessage;
/**
 ...
 */
export interface IKernelIOPubErrorMessage extends IKernelMessage {
    content: {
        execution_count: number;
        ename: string;
        evalue: string;
 ...
 */
export declare function isErrorMessage(msg: IKernelMessage): msg is IKernelIOPubErrorMessage;
/**
 ...
 */
export interface IKernelIOPubStatusMessage extends IKernelMessage {
    content: {
 ...
 */
export declare function isStatusMessage(msg: IKernelMessage): msg is IKernelIOPubStatusMessage;
/**
 ...
 */
export interface IKernelIOPubClearOutputMessage extends IKernelMessage {
    content: {
        wait: boolean;
    };
}
 ...
 */
export declare function isClearOutputMessage(msg: IKernelMessage): msg is IKernelIOPubClearOutputMessage;
/**
