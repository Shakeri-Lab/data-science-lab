...
function Navbar() {
  return (
    <div className="App">
        <ReactBootstrap.Navbar style={{boxShadow: "2px 4px 6px gray", borderBottomLeftRadius: 5, borderBottomRightRadius: 5}} collapseOnSelect expand="lg" bg="dark" variant="dark">
